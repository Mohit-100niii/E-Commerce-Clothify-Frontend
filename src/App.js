...
import ColorsList from "./components/Admin/Categories/ColorList";
    ...
    <Navbar/>
      ...
      <Routes>
        ...
        <AdminDashboard/>
          ...
          {/* products */} <Route path="" element={<AdminRoutes>
            <OrdersList />
          </AdminRoutes>} />
          <Route path="add-product" element={<AdminRoutes>
            <AddProduct />
          </AdminRoutes>} />
          <Route path="manage-products" element={<AdminRoutes>
            <ManageStocks />
          </AdminRoutes>} />
          <Route path="products/edit/:id" element={<AdminRoutes>
            <ProductUpdate />
          </AdminRoutes>} />
          {/* coupons */}
          <Route path="add-coupon" element={<AdminRoutes>
            <AddCoupon />
          </AdminRoutes>} />
          <Route path="manage-coupon" element={<AdminRoutes>
            <ManageCoupons />
          </AdminRoutes>} />
          <Route path="manage-coupon/edit/:code" element={<AdminRoutes>
            <UpdateCoupon />
          </AdminRoutes>} />
          {/* Category */}
          <Route path="category-to-add" element={<AdminRoutes>
            <CategoryToAdd />
          </AdminRoutes>} />
          <Route path="add-category" element={<AddCategory />} />
          <Route path="manage-category" element={<AdminRoutes>
            <ManageCategories />
          </AdminRoutes>} />
          <Route path="edit-category/:id" element={<AdminRoutes>
            <UpdateCategory />
          </AdminRoutes>} />
          {/* brand category */}
          <Route path="add-brand" element={<AdminRoutes>
            <AddBrand />
          </AdminRoutes>} />
          <Route path="all-brands" element={<AdminRoutes>
            <BrandsList />
          </AdminRoutes>} />
          {/* color category */}
          <Route path="add-color" element={<AdminRoutes>
            <AddColor />
          </AdminRoutes>} />
          <Route path="all-colors" element={<AdminRoutes>
            <ColorsList />
          </AdminRoutes>} />
          {/* Orders */}
          <Route path="manage-orders" element={<ManageOrders />} />
          <Route path="orders/:id" element={<AdminRoutes>
            <UpdateOrders />
          </AdminRoutes>} />
        ...
        {/* shopping cart */}
        <Route path="/shopping-cart" element={<AuthRoute>
          <ShoppingCart />
        </AuthRoute>} />
        <Route path="/order-payment" element={<AuthRoute>
          <OrderPayment />
